<template>
    <div class="panel-course-iteration-list-view">
        <div id="options"></div>
...
<script>
    ...
    export default {
        ...
        data() {
            ...
            return {
                ...
                dt: {
                    ...
                    service: CourseIterationService,
                    listMethod: "listCourseIterations",

                    beforeRequest(){
                        return self.getCourseIteration().then(self.getAcademicUnits);
                    },
        ...
        methods: {
            getCourseIteration() {
                return CourseIterationService.getCourseIteration()
                    .then(res => {
                        if (res.code == 200) {
            ...
            goDetail($event, id){
                ...
                if(typeof id != 'undefined') {
                    this.$router.push({ name: 'institution-administration-panel/course-iteration-edit', params: { id } });
                }else {
                    this.$router.push({ name: 'institution-administration-panel/course-iteration-new'});
                }
            },
        }
    }
