<template>
    <div class="panel-academic-unit-detail-view">
        <div class="panel panel-default">
            <div class="panel-heading">
                {{ isEdit ? $t('lbl.edit-academic-unit') : $t('lbl.insert-new-academic-unit') }}
            </div>
                            ...
                            <div id="general" class="tab-pane fade in active general">
                                <div class="mt50">
                                    <div class="form-group">
                                        <label class="col-sm-2 col-md-2 control-label">{{$t('lbl.unit-name')}}:</label>
                                        <div class="col-sm-10 col-md-6">
                                            <multi-lang-text :value="item.name"></multi-lang-text>
                                        </div>
                                    </div>
                                    <div class="form-group mt40">
                                        <label class="col-sm-2 col-md-2 control-label">{{$t('lbl.description')}}:</label>
                                        <div class="col-sm-10 col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 col-md-2 control-label">{{$t('lbl.code')}}:</label>
                                        <div class="col-sm-10 col-md-6">
                                            <input v-model="item.code" type="text" placeholder="Kod giriniz">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 col-md-2 control-label">{{$t('lbl.type')}}:</label>
                                        <div class="col-sm-10 col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 col-md-2 control-label">{{$t('lbl.manager')}}:</label>
                                        <div class="col-sm-10 col-md-6">
                                            <select class="btn-block">
                                                <option>{{$t('lbl.choose')}}</option>
                                            </select>
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 col-md-2 control-label">{{$t('lbl.manager-authority')}}:</label>
                                        <div class="col-sm-10 col-md-6">
                                            <select class="btn-block">
                                                <option>{{$t('lbl.choose')}}</option>
                                            </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10 col-md-6">
                                            <input v-model="item.url" type="text" placeholder="http://" required>
                                        </div>
                                    </div>
...
<script>
    ...
    import {AcademicService, AcademicUnitModel} from 'src/services/data/academic'
    ...
    export default {
        ...
        methods: {
            getItem() {
                ...
                AcademicService.getAcademicUnit(this.$route.params.id)
                    .then(res => {
                        this.loading = false;
            ...
            saveItem() {
                ...
                if (this.isEdit) {
                    AcademicService.updateAcademicUnit(this.item, this.$route.params.id)
                        .then(res => {
                    ...
                    AcademicService.insertAcademicUnit(this.item)
                        .then(res => {
                            this.loadingSave = false;
