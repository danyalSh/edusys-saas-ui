<template>
    <div class="panel-course-plan-list-view">
        <div id="options"></div>

        <div class="panel panel-default">
            <div class="panel-heading">
                {{$t('lbl.course-plan-list')}}
            </div>
                ...
                <div class="row mb20">
                    <div class="col-md-10">
                        <div class="panel-head-title">
                            Üniversite Bünyesindeki Müfredatlar
                        </div>
        ...
        methods: {
            ...
            goDetail($event, id){
                ...
                if(typeof id != 'undefined') {
                    this.$router.push({ name: 'institution-administration-panel/course-plan-edit', params: { id } });
                }else {
                    this.$router.push({ name: 'institution-administration-panel/course-plan-new'});
                }
            },
        }
    }
